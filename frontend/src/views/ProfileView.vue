            ...
            <form>
                <div class="row mt-5 align-items-center">
                    <div class="col-md-3 text-center mb-5">
                        <div class="avatar avatar-xl">
                            <img src="https://bootdey.com/img/Content/avatar/avatar5.png" alt="..." class="avatar-img rounded-circle" />
                        </div>
                    </div>
                    <div class="col">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-7">
                                <p class="text-muted">
                                    ...
                                    pretium blandit sapien.(Description)
                                </p>
                            </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="firstname" class="bio">Bio</label>
                        <input type="text" id="firstname" class="form-control" placeholder="Change here" />
                    </div>
                </div>
